...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _managing_tasks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./managing-tasks */ \"./src/managing-tasks.js\");\n\n\n\n_managing_tasks__WEBPACK_IMPORTED_MODULE_1__.app.addProject('Julka');\n_managing_tasks__WEBPACK_IMPORTED_MODULE_1__.DOM.loadProjects();\n\n//# sourceURL=webpack://todolist/./src/index.js?");

/***/ }),

/***/ "./src/managing-tasks.js":
/*!*******************************!*\
  !*** ./src/managing-tasks.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"DOM\": () => (/* binding */ DOM),\n/* harmony export */   \"app\": () => (/* binding */ app)\n/* harmony export */ });\n/* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./projects */ \"./src/projects.js\");\n\n\nconst app = (() => {\n    const projects = [];\n    const addProject = (name) => {\n        const newProject = (0,_projects__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(name);\n        projects.push[newProject];\n    }\n    const getProjects = () => projects;\n\n    return { addProject, getProjects }\n})();\n\nconst DOM = (() => {\n\n    const loadProjects = () => {\n        const nav = document.querySelector('nav');\n        const projects = app.getProjects();\n\n        for (let i = 0; i < projects.length; i++) {\n            const project = projects[i];\n            const projectName = document.createElement('span');\n            projectName.innerText = project.getName();\n            nav.appendChild(projectName);\n        }\n    }\n    return { loadProjects }\n})();\n\n\n//# sourceURL=webpack://todolist/./src/managing-tasks.js?");
